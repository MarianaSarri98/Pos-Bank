...
export const Styling = "/assets/styling.png";
export const Context = "/assets/context.png";
export const Assets = "/assets/assets.png";
export const Docs = "/assets/docs.png";
export const Share = "/assets/share.png";
export const FigmaPlugin = "/assets/figma-plugin.png";
export const Testing = "/assets/testing.png";
export const Accessibility = "/assets/accessibility.png";
export const Theming = "/assets/theming.png";
export const AddonLibrary = "/assets/addon-library.png";
