...
export const Tutorials = "/tutorials.svg";
export const Styling = "/styling.png";
export const Context = "/context.png";
export const Assets = "/assets.png";
export const Docs = "/docs.png";
export const Share = "/share.png";
export const FigmaPlugin = "/figma-plugin.png";
export const Testing = "/testing.png";
export const Accessibility = "/accessibility.png";
export const Theming = "/theming.png";
export const AddonLibrary = "/addon-library.png";
