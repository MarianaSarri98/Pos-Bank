...
const Discord = "/assets/discord.svg";
const Youtube = "/assets/youtube.svg";
const Tutorials = "/assets/tutorials.svg";
const Styling = "/assets/styling.png";
const Context = "/assets/context.png";
const Assets = "/assets/assets.png";
const Docs = "/assets/docs.png";
const Share = "/assets/share.png";
const FigmaPlugin = "/assets/figma-plugin.png";
const Testing = "/assets/testing.png";
const Accessibility = "/assets/accessibility.png";
const Theming = "/assets/theming.png";
const AddonLibrary = "/assets/addon-library.png";
